...
.responsiveMenuTheme2{list-style:none;zoom:1;background:#a42a2a;margin:0;padding:0;font-size: 14px;width: 100%;}
...
.responsiveMenuTheme2 a:hover, .responsiveMenuTheme2 li.active > a, .responsiveMenuTheme2 li > span.separator:hover{color:#ffffff;background-color: #942626}
...
.responsiveMenuTheme2 span.opener{background-repeat:no-repeat;background-position:11px center;width:40px;text-indent: 100px;overflow: hidden;display: inline-block;padding: 15px 0;vertical-align: middle;position: absolute;right: 0;top: 0;}
...
.responsiveMenuTheme2 span.linker > li > ul > li > ul > li > ul{border: solid #000;}
.responsiveMenuTheme2 > li > ul > li > ul > li > ul{left:100%;top:0;}
.responsiveMenuTheme2 > li > ul > li > ul > li > ul > li > ul{left:100%;top:0;}
.responsiveMenuTheme2 li li > a{display:block;background:#c63333;position:relative;z-index:100;border-top:1px solid #942626;white-space:nowrap;}
.responsiveMenuTheme2 li ul li span.linker{padding: 5px 0px !important;}
...
.responsiveMenuTheme2 li li span.separator {display:block;background:#c63333;position:relative;z-index:100;border-top:1px solid #942626;}
.responsiveMenuTheme2 li li li a{background:#da3838;z-index:200;border-top:1px solid #942626;}
.responsiveMenuTheme2 li li.parent a{padding: 0 40px 0 15px;}

.toggleMenu{display:none;color:#ffffff;padding:10px 15px;background:#942626 url(../images/toggle-icon.png) no-repeat left center;height:40px;padding:0 0px 0 40px;line-height:40px;border-radius: 5px;font-family:"PT Sans Narrow","Arial Narrow",Arial,Helvetica,sans-serif;font-size: 18px;}
.toggleMenu span{padding-right:10px;}
.toggleMenu.active{border-radius: 5px 5px 0 0;}
.responsiveMenuTheme2.isMobile .active{display:block;}
.responsiveMenuTheme2.isMobile > li{float:none;border-top:1px solid #942626;}
...
.responsiveMenuTheme2 li li span.navHeader {display:block;background:#c63333;position:relative;z-index:100;border-top:1px solid #942626;}
.responsiveMenuTheme2.isDesktop > li > a{border-left:1px solid #942626;border-bottom:none;}
.responsiveMenuTheme2.isDesktop li a, .responsiveMenuTheme2.isDesktop li span.separator, .responsiveMenuTheme2.isDesktop li span.navHeader{border-left:1px solid #942626;border-bottom:none;}
.responsiveMenuTheme2.isDesktop li li span.opener{background-image:url(../images/right-bg.png);background-position: center; padding-bottom:5px;}
